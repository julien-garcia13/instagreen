              ...
              <div class="card">
                <div class="card-body p-4">
                        ...
                        <div class="card-body">
                          <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center">
                              <!-- Image du produit -->
                              <div>
                                <img src="../<?= $produit->img ?>" class="image-produit-panier" alt="Shopping item" style="width: 65px;"/>
                              </div>
                              <div class="ms-3">
                                <!-- Nom du produit -->
                                <h5><?= $produit->nom ?></h5>
                  ...
                  <div class="d-flex justify-content-between mb-4">
                    ...
                    <div class="d-flex justify-content-between">
                      <button class="btn btn-info btn-block btn-lg" alt="Boutton pour payer">Procéder au paiement<i class="fas fa-long-arrow-alt-right"></i></button>
                    </div>
                  </form>
                  </button>
                </div>
